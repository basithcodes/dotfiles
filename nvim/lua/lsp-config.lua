...
--buf_set_keymap('n', ']d', '<cmd>lua vim.diagnostic.goto_next({severity = vim.diagnostic.severity.ERROR, popup_opts = {border = "single"}})<CR>', opts)
--buf_set_keymap('n', '[d', '<cmd>lua vim.diagnostic.goto_prev({severity = vim.diagnostic.severity.ERROR, popup_opts = {border = "single"}})<CR>', opts)
